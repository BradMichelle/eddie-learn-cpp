...
int main() {
    ...
    int astronautAge;
    while (!(std::cin >> astronautAge && astronautAge >= 8 && astronautAge <= 18)) {
        if (std::cin.fail()) {
    ...
    while (!(std::cin >> astronautHeight && astronautHeight >= 1.0 && astronautHeight <= 2.2)) {
        if (std::cin.fail()) {
    ...
    while (!(std::cin >> astronautWeight && astronautWeight >= 20.0 && astronautWeight <= 100.0)) {
        if (std::cin.fail()) {
    ...
    while (!(std::cin >> missionDistance && missionDistance > 0)) {
        if (std::cin.fail()) {
    ...
    std::cout << "Moon weights the astronaut at " << astronautWeight * 0.165 << " kg" << std::endl;
    std::cout << "Mars weights the astronaut at " << astronautWeight * 0.38 << " kg" << std::endl;
    std::cout << "Astronaut BMI: " << astronautBMI << std::endl;
